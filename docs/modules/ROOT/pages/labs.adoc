...
=== 2.6 Pretvaranje singletona u galera replika set
...
=== 4.11 Kako obrisati veliku količinu podataka i osloboditi prostor u MongoDB-u
...
CAUTION: U MongoDB-u, verzija 4.4 ili novijoj, compact će blokirati samo operacije nad metapodacima kao što su brisanje kolekcije, brisanje indeksa ili stvaranje novog indeksa.
